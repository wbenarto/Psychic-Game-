//Create containers that stores compPick, winsCount, lossesCount, guessesCount, userInput
var wins = 0;
var losses = 0;
var guessesLeft = 9; 


//Array that holds all letters
var letters = ["a","s","d","f","g","h","j","k","l","t"];
...
var updateGuessesSoFar = function() {
    document.querySelector(".user-input").innerHTML = guessedLetters.join(", ");
};
...
if (letter === letterToGuess) {
    ...
    document.querySelector(".comp-pick").innerHTML = letterToGuess;
    reset();
}
